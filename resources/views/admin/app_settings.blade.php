...
<div class="main-panel bg-dark">
                                        ...
                                        <form method="POST" action="{{route('web.info')}}"
                                            ...
                                            <div class=" form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <textarea name="widget" class="form-control bg-dark text-light"
                                                        rows="4">{{$web_info->widget}}</textarea>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <h5 class="text-light">Timezone</h5>
                                                    <select name="timezone"
                                                        class="form-control bg-dark text-light select2">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <h5 class="text-light">Logo (Recommended size; max width, 200px and
                                                        max height 100px.)</h5>
                                                    <input name="logo" class="form-control bg-dark text-light"
                                                        type="file">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <h5 class="text-light">Favicon (Recommended type: png, size: max
                                                        width, 32px and max height 32px.)</h5>
                                                    <input name="favicon" class="form-control bg-dark text-light"
                                                        type="file">
                                                </div>
                                            </div>
                                        ...
                                        <form method="POST" action="{{route('update.preferences')}}"
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <small class="text-light">Note: To use AWS S3, please supply your
                                                        AWS information in the .ENV file</small>
                                                </div>
                                            ...
                                            <div class="mt-3 row">
                                                ...
                                                <div class="mt-4 col-md-6">
                                                    ...
                                                    <div>
                                                        <small class="text-light">if turned off, Users will not receive
                                                ...
                                                <div class="mt-4 col-md-6">
                                                    ...
                                                    <div>
                                                        <small class="text-light">if disabled, Users will not be able to
                                                ...
                                                <div class="mt-4 col-md-6">
                                                    ...
                                                    <div>
                                                        <small class="text-light">if turned on, Users will need to pass
                                                ...
                                                <div class="mt-4 col-md-6">
                                                    ...
                                                    <div>
                                                        <small class="text-light">if turned on, Users will have the
                                                ...
                                                <div class="mt-4 col-md-6">
                                                    ...
                                                    <div>
                                                        <small class="text-light">if turned on, Users will need to
                                                            submit required documents to get verified before they can
                                                            place a withdrawal request.</small>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mt-4 col-md-6">
                                                    ...
                                                    <div>
                                                        <small class="text-light">Google Login allows users to
                                                ...
                                                <div class="mt-4 col-md-6">
                                                    ...
                                                    <div>
                                                        <small class="text-light">If email verification is disabled
                                                            users will not be ask to verify their email address.</small>
                                                    </div>
                                                </div>
                                            ...
                                            <div class=" form-row">
                                                ...
                                                <div class="form-group col-md-6 smtp d-none">
                                                    ...
                                                    <input type="text" name="host"
                                                        class="form-control bg-dark text-light smtpinput"
                                                        value="{{$smtp->host}}">
                                                </div>
                                                <div class="form-group col-md-6 smtp d-none">
                                            ...
                                            <div class=" form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" name="url"
                                                        class="form-control bg-dark text-light" value="{{$smtp->url}}">
                                                    <small class="text-light">Set this to your Valid OAuth Redirect URI
                                            ...
                                            <div class=" form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" name="secret"
                                                        class="form-control bg-dark text-light" value="{{$smtp->key}}">
                                                    <small class="text-light"> From
                                            ...
                                            <div class=" form-row">
                                                ...
                                                <div class="form-group col-md-6 facebook">
                                                    ...
                                                    <input type="email" name="site_name"
                                                        class="form-control bg-dark text-light" value="locke stock"
                                                        required>
	...
	// 	// alert('love');
	// 	$.ajax({
	// 		url: "account/admin/dashboard/updatewebinfo",
	// 		type: 'POST',
	...
	$('#updatepreference').on('submit', function() {
		//alert('love');
		$.ajax({
			url: "account/admin/dashboard/updatepreference",
			type: 'POST',
	...
	$('#emailform').on('submit', function() {
		//alert('love');
		$.ajax({
			url: "account/admin/dashboard/updateemail",
			type: 'POST',
