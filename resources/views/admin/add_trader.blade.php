                ...
                <div class="col-lg-12 ">
                    <div class="p-3 card bg-dark">
                        <form action="{{url('add-expert')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input placeholder="Enter Plan minimum price"
                                        class="form-control text-light bg-dark" type="text" name="trading_min_amount"
                                        required>
                            ...
                            <input class="form-control text-light bg-dark" placeholder="Enter Additional Gift Bonus"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <small class="text-light">This specifies how often the system should add profit(ROI) to
                                    user account.</small>
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control text-light bg-dark" placeholder="top up amount" type="text"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control text-light bg-dark" placeholder="Enter Coppiers ROI"
                                        type="text" name="copier_roi" required>

                                </div>
                                <div class="form-group col-md-6">
                                    <h5 class="text-light">Profit Share</h5>
                                    <input class="form-control text-light bg-dark" placeholder="Enter risk" type="text"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control text-light bg-dark" placeholder="Enteractive traders"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control text-light bg-dark" placeholder="upload image"
