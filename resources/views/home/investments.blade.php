...
<article class="main-layout__content">
  ...
  <div class="tradingview-widget-container " data-aos="fade-up">
    ...
    <div class="tradingview-widget-copyright"><a href="externala3cba3cb.html?link=https://www.tradingview.com/"
  ...
  <script type="text/javascript" src="s3.tradingview.com/external-embedding/embed-widget-forex-cross-rates.html" async>
    {
"width": "100%",
"height": "400",
"colorTheme": "dark",
  ...
  <section class="deposits">
    <div class="container container-large">
          ...
          <div class="swiper-wrapper">
              ...
              <div class="deposits-item is-active" deposit="Starting">
                <div class="deposits-item__content">
                  <div class="deposits-item__count" style="margin: 0;">
                    <div class="deposits-item__count-number">2 </div>
                    <div class="deposits-item__count-content">
                      <p class="deposits-item__count-sub">%
                      </p>
                      <p class="deposits-item__count-desc">ROOKIE PLAN </p>
                    </div>
                  </div>
                  ...
                  <div class="deposits-item__item">
                    ...
                    <p class="deposits-item__item-value">$5000 - $20000
                    </p>
                  </div>
                  <div class="deposits-item__item deposits-item__item--earn">
                    <p class="deposits-item__item-title">6 Days</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="swiper-slide">
              <div class="deposits-item is-active" deposit="Starting">
                <div class="deposits-item__content">
                  <div class="deposits-item__count" style="margin: 0;">
                    <div class="deposits-item__count-number">3 </div>
                    <div class="deposits-item__count-content">
                      <p class="deposits-item__count-sub">%
                      </p>
                      <p class="deposits-item__count-desc">ENTHUSIAST PLAN </p>
                    </div>
                  </div>
                  <div class="deposits-item__item deposits-item__item--earn">
                    <p class="deposits-item__item-title">Daily</p>
                  ...
                  <div class="deposits-item__item">
                    ...
                    <p class="deposits-item__item-value">$30000 - $90000
                    </p>
                  </div>
                  <div class="deposits-item__item deposits-item__item--earn">
                    <p class="deposits-item__item-title">20 Days</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="swiper-slide">
              <div class="deposits-item is-active" deposit="Starting">
                <div class="deposits-item__content">
                  <div class="deposits-item__count" style="margin: 0;">
                    <div class="deposits-item__count-number">80 </div>
                    <div class="deposits-item__count-content">
                      <p class="deposits-item__count-sub">%
                      </p>
                      <p class="deposits-item__count-desc">PROFESSIONAL PLAN </p>
                    </div>
                  </div>
                  <div class="deposits-item__item deposits-item__item--earn">
                    <p class="deposits-item__item-title">Daily</p>
                  ...
                  <div class="deposits-item__item">
                    ...
                    <p class="deposits-item__item-value">$100000 - $1000000000
                    </p>
                  </div>
                  <div class="deposits-item__item deposits-item__item--earn">
                    <p class="deposits-item__item-title">30 Days</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="deposits-item__content">
                  <div class="deposits-item__count" style="margin: 0;">
                    ...
                    <div class="deposits-item__count-content">
                      ...
                      <p class="deposits-item__count-desc">MASTER PLAN </p>
                    </div>
                  </div>
                  <div class="deposits-item__item deposits-item__item--earn">
                    <p class="deposits-item__item-title">Daily</p>
                  ...
                  <div class="deposits-item__item">
                    ...
                    <p class="deposits-item__item-value">$50000 - $5000000000000
                    </p>
                  </div>
                  <div class="deposits-item__item deposits-item__item--earn">
                    <p class="deposits-item__item-title">60 Days</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <!-- <div class="swiper-slide">
              <div class="deposits-item is-active" deposit="Starting">
                <div class="deposits-item__content">
                  <div class="deposits-item__count"style="margin: 0;"> 
                    <div class="deposits-item__count-number">50                              </div>
                    <div class="deposits-item__count-content"> 
                      <p class="deposits-item__count-sub">%
                      </p>
                      <p class="deposits-item__count-desc">Children Scholarships Plan                               </p>
                    </div>
                  </div>
                  <div class="deposits-item__item deposits-item__item--earn">
                    <p class="deposits-item__item-title">Daily</p>
                  ...
                  <div class="deposits-item__item"> 
                    ...
                    <p class="deposits-item__item-value">$100000  - $100000000
                    </p>
                  </div>
                  <div class="deposits-item__item deposits-item__item--earn">
                    <p class="deposits-item__item-title">20 Days</p>
            ...
            <div class="typography">
              <ul>
                ...
                <li>
                  ...
                  <p><span class="color-primary">0.5%</span> for technical support of the robot and the company as a
                    whole. This commission includes the development and marketing costs of the company.</p>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="deposits__calculate">
        <div class="calculate-profit"><a class="btn btn--line-primary js-open-calculate-form"> <span>Calculate
              Profit</span></a>
          <form>
            <div class="calculate-profit__block">
              <div class="calculate-profit__block-row">
                <div class="field">
                  ...
                  <div class="select-deposit">
                    <div class="select-deposit__trigger">
                      <p class="select-deposit__value"><span class="select-deposit__val">Starting</span> <strong><span
                            class="select-deposit__percent">1.8</span><sup>%</sup></strong></p>
                    </div>
                ...
                <ul class="calculate-stats">
                  <li>
                    <p class="calculate-stats__value" id="daily">180</p>
          ...
          <div class="swiper-slide">
            <div class="funds-item">
              ...
              <div class="funds-item__description">
                <p>Our team of professionals have created a unique trading robot that makes profit at any stage of the
                  market: rise or fall</p>
              </div>
            </div>
          </div>
          <div class="swiper-slide">
              ...
              <table>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>3051 N D St San Bernardino, California(CA), 92405T</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div class="swiper-slide">
            <div class="steps-item">
              ...
              <div class="steps-item__description">
                <p>Click the Register button. Fill in your details to create a FREE account in seconds</p>
              </div>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="steps-item">
              ...
              <div class="steps-item__description">
                <p>We offer a variety of investment plans to suit your financial goals. After reading, make a deposit
                </p>
              </div>
            </div>
          </div>
