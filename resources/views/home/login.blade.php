...
<!-- Mirrored from fxbitozglobals.com/login by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Apr 2025 17:44:16 GMT -->
<!-- Added by HTTrack -->
...
<head>
    <meta charset="utf-8">
    <meta name="csrf-token" content="Lvafl4JvU48orBSjdIDdCkI5GtFPVJlewcAjqGQe">
    ...
    <!-- Favicon -->
    <link rel="icon" href="public/uploads/RhwcKb04EF13PKrSoSxx.png" sizes="any">
    ...
    <!-- Page Title -->
    <title>Login account | Wealth Connect</title>
        ...
        <div class="row align-items-center justify-content-center vh-100">
            <div class="col-11 col-sm-8 col-md-6 col-lg-5 col-xl-4 col-xxl-3 py-6 shadow-sm">
                ...
                <div class="text-center">
                    <a href="{{ url('/') }}">
                        <img src="uploads/41OJya5mQbiJ8aS3gLid.png" alt="Logo" class="w-50">
                    </a>
                </div>
                <!-- Title -->
                ...
                <!-- Form -->
                <form method="POST" action="https://fxbitozglobals.com/login">
                    ...
                    <div class="row align-items-center text-center">
                        ...
                        <div class="col-12">
                            ...
                            <!-- Link -->
                            <small class="mb-0 text-muted">Don't have an account yet? <a href="{{ url('/register') }}"
...
<!-- Mirrored from fxbitozglobals.com/login by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Apr 2025 17:44:17 GMT -->
