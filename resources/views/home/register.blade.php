...
<head>
    ...
    <!-- Page Title -->
    <title>Sign up | Wealth Connect</title>
    ...
    <main class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-md-7 col-lg-6 px-lg-4 px-xl-8 d-flex flex-column vh-100 py-6">
                <a href="{{ url('/') }}" class="navbar-brand mb-auto">
                    ...
                    <form method="POST" action="https://fxbitozglobal.com/register">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="agree">
                                I agree with <a href="public/i/index.html">Terms & Conditions</a> and have understood
                ...
                <div class="mt-auto">
                    ...
                    <small class="mb-0 text-muted">
                        Already registered? <a href="{{ url('/login') }}" class="fw-semibold">Login</a>
                    </small>
                </div>
            </div>
